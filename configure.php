	   ...
	   <br><table border="1"><tr><td>
		   ...
		   <tr><td>
		   	<input type="checkbox" name="winningpatternform1" <?php echo ($winningpattern1=="on")?"checked":""; ?>>
		   	&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[1];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=1" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
	   		<input type="checkbox" name="winningpatternform2" <?php echo ($winningpattern2=="on")?"checked":""; ?>>
	   		&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[2];?>
	   	</td><td>
	   		<a href="interactive.php?cardnumber=2" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
	   		<input type="checkbox" name="winningpatternform3" <?php echo ($winningpattern3=="on")?"checked":""; ?>>
	   		&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[3];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=3" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
			   <input type="checkbox" name="winningpatternform4" <?php echo ($winningpattern4=="on")?"checked":""; ?>>
			   &nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[4];?>
	      </td><td>
			   <a href="interactive.php?cardnumber=4" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
			   <input type="checkbox" name="winningpatternform5" <?php echo ($winningpattern5=="on")?"checked":""; ?>>
			   &nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[5];?>
		   </td><td>
				<a href="interactive.php?cardnumber=5" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
	   		<input type="checkbox" name="winningpatternform6" <?php echo ($winningpattern6=="on")?"checked":""; ?>>
	   		&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[6];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=6" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
			   <input type="checkbox" name="winningpatternform7" <?php echo ($winningpattern7=="on")?"checked":""; ?>>
			   &nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[7];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=7" target=_blank>customize!</a>
	   	</td></tr>
	   	<tr><td>
	   		<input type="checkbox" name="winningpatternform8" <?php echo ($winningpattern8=="on")?"checked":""; ?>>
	   		&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[8];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=8" target=_blank>customize!</a>
	   	</td></tr>
		   <tr><td >
		   	<input type="checkbox" name="winningpatternform9" <?php echo ($winningpattern9=="on")?"checked":""; ?>>
		   	&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[9];?>
		   </td><td>
			   <a href="interactive.php?cardnumber=9" target=_blank>customize!</a>
	   	</td></tr>
		   <tr><td >
		   	<input type="checkbox" name="winningpatternform10" <?php echo ($winningpattern10=="on")?"checked":""; ?>>
		   	&nbsp;&nbsp;&nbsp;<?php echo $patternkeywords[10];?>
		   </td><td>
		...
		<table border="1" width="30%"><tr><td><table border="0"> 
			<tr>
				...
				<td>Automatic
					...
					<input type="radio" name="drawmodeform" value="automatic" <?php echo ($drawmode=="automatic")?"checked":""; ?>>
				</td>
			</tr><tr>
				<td>Manual
				</td><td>
					<input type="radio" name="drawmodeform" value="manual" <?php echo ($drawmode=="manual")?"checked":""; ?>>
				</td>
			</tr></table>
			</tr></table>
		<br>
		<table border="1" width="30%"><tr><td><table border="0"> 
			<tr>
		   	...
		   	Name File</td><td><input type="checkbox" name="namefileform" <?php echo ($namefile=="on")?"checked":""; ?>>
		   	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:explain('Name File')">help?</a>
		   </td></tr>
	   		<tr><td >
		   	Print Rules</td><td><input type="checkbox" name="printrulesform" <?php echo ($printrules=="on")?"checked":""; ?>>
		   	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:explain('Print Rules')">help?</a>
		   </td></tr>
		   
		   <tr><td >
		   	Print 4 cards per page</td><td><input type="checkbox" name="fourperpageform" <?php echo ($fourperpage=="on")?"checked":""; ?>>
	   				...
	   				<table border="0"> 
						...
						<tr>
							...
							<td align="center">
								...
								<input id="pick1067301017field" size="7" type="hidden" name="headerbgcolorform" value="<?php echo $headerbgcolor; ?>">
							...
							<td align="center">
								<a href="javascript:pickColor('pick1067300926');" id="pick1067300926"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067300926field" size="7" type="hidden" name="headerfontcolorform" value="<?php echo $headerfontcolor; ?>">
						...
						<tr>
							...
							<td align="center">
								<a href="javascript:pickColor('pick1067301091');" id="pick1067301091"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067301091field" size="7" type="hidden" name="mainbgcolorform" value="<?php echo $mainbgcolor; ?>">
							...
							<td align="center">
								<a href="javascript:pickColor('pick1067300494');" id="pick1067300494"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067300494field" size="7" type="hidden" name="mainfontcolorform" value="<?php echo $mainfontcolor; ?>">
						...
						<tr>
							...
							<td align="center">
								<a href="javascript:pickColor('pick1067301185');" id="pick1067301185"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067301185field" size="7" type="hidden" name="selectedbgcolorform" value="<?php echo $selectedbgcolor; ?>">
							...
							<td align="center">
								<a href="javascript:pickColor('pick1067301286');" id="pick1067301286"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067301286field" size="7" type="hidden" name="selectedfontcolorform" value="<?php echo $selectedfontcolor; ?>">
						...
						<tr>
							...
							<td align="center">
								<center><a href="javascript:pickColor('pick1067301200',3);" id="pick1067301200"
									style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
									text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
								<input id="pick1067301200field" size="7" type="hidden" name="bordercolorform" value="<?php echo $bordercolor; ?>">
