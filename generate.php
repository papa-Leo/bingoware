	   ...
	   <?php if (isset($_POST["submit"]) && isset($_POST["numcard"]) && ($_POST["numcard"]>1) && ($_POST["numcard"]<$MAX_LIMIT)) {
	   ...
	   ?>
	   <p><img src="images/gc.gif"><br><br>(Set ID: <?php echo $setid; ?>)&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:explain('Set ID')">help?</a></p>
	   <form action="index.php?action=generate" method="post">
	   Enter the number of Bingo cards desired (between 1 and <?php echo $MAX_LIMIT; ?>): 
	   ...
	   <input type="radio" name="freesquare" value="0" checked>&nbsp;&nbsp;&nbsp;No "Free" Squares
	   <br>
	   <input type="radio" name="freesquare" value="1">&nbsp;&nbsp;&nbsp;"Free" Squares in the center of every card
	   <br>
